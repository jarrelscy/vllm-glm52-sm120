...
| Profile | 128-prompt decodeTPS | 4096-prompt decodeTPS | Normalized 128 estimate | Normalized 4096 estimate |
| --- | ---: | ---: | ---: | ---: |
...
NormalizedTPS is a counter-derived estimate at original pooled 1+accepted/drafts; it is not a measured forced-acceptance rerun.
...
Throughput on repeatedpangram input can reflect nearly 100% MTPacceptance; do not generalize to realistic workload quality.

## Final communication build

One measured request after one warmup, same 136-token prompt and 512 output: **138.401 tokens/s**, TTFT251.330 ms,4.0 emitted tokens/draft step and 28.846ms/step. Previous ARVQ build 138.197; original AQLM hybrid MTP-on 97.163 (three-run mean). This repeated-pangram workload accepts every draft; full task accuracy remains unmeasured.
